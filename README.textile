...
NetEditor is designed to create editors for "Visual Programmaing Languages":http://en.wikipedia.org/wiki/Visual_programming_language. It assumes that the language constructs are defined independently from the graphical representations of these constructs. 
