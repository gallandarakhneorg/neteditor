...
/** End Caps for stroke in PDF files.
 *  
...
public enum PdfEndCaps {
	...
	private PdfEndCaps(EndCap endCap, int pdf) {
		this.endCap = endCap;
		this.pdf = pdf;
	}
	...
	/** Replies the value of the end caps for the PDF file.
	 * 
	 * @return the value of the end caps for the PDF file.
	 */
	public int pdf() {
		return this.pdf;
	}
	 ...
	 */
	public static PdfEndCaps fromGenericType(EndCap endCap) {
		for(PdfEndCaps caps : PdfEndCaps.values()) {
