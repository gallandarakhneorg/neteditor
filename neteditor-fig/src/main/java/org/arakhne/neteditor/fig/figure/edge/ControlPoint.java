...
/** This is the implementation of an edge control point.
 * It is a Point2D that can be modified only from an edge.
 *
 *
 ...
 */
class ControlPoint extends UnmodifiablePoint2f {
