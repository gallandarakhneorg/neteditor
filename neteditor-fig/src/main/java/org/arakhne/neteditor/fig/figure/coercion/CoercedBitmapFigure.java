...
/** Bitmap Figure that is associated to an anchor
...
public class CoercedBitmapFigure extends BitmapFigure implements CoercedFigure {
	 ...
	 * @param image is the image to put in the object.
	 ...
	 * @throws IOException
	 */
	public CoercedBitmapFigure(UUID viewId, URL image, float anchorX, float anchorY) throws IOException {
		super(viewId);
		this.update = false;
		setMinimalWidth(1);
		setMinimalHeight(1);
	 ...
	 * @throws IOException
	 */
	public CoercedBitmapFigure(UUID viewId) throws IOException {
